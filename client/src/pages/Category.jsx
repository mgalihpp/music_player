...
const Category = () => {
  ...
  return (
    <>
      ...
      <div
        className={`flex flex-row flex-wrap items-start mx-auto justify-center sm:justify-start gap-2 bg-gradient-to-b ${selectedCat?.re} ${selectedCat?.to} sm:gap-4 py-12 px-4
        `}
      >
        {compLoad ? (
